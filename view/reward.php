                ...
                <div class="row">
                    <div class="col l-12">
                        <ul class="content__top">
                            ...
                            <li class="content__item">/</li>
                            <li class="content__item">Ưu đãi cho bạn</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col l-9 m-12 c-12 hide-on-moblile-tablet">
                            ...
                            <div class="table-head">
                                <ul class="table-item">
                                    <li class="table-padding table--active">
                                        <a class="table-link table--active"  href="">Ưu đãi chưa lấy</a>
                                    </li>
                                    <li class="table-padding">
                                        <a class="table-link" href="">Ưu đãi đã lấy</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="trip-content">
                            <div class="trip-item">
                                ...
                                <p  class="empty-text">Hiện tại <strong>NICETRIP</strong> chưa có quá tặng nào</p>
                            </div>
                        </div>
                    </div>
                </div>
